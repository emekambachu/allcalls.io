...
Route::get('/call/incoming', function() {
    ...
    $twiml = '<?xml version="1.0" encoding="UTF-8"?>';
    // $twiml .= '<Response><Dial answerOnBridge="true" callerId="' . $numberToDial . '">' . '<Client>+15736523170</Client>' . '</Dial></Response>';
    $twiml .= '<Response><Dial answerOnBridge="true"><Client callerId="+15736523170">blue</Client></Dial></Response>';
...
Route::middleware('auth:sanctum')->post('/twilio-ios-access-token', [TwilioIOSAccessTokenController::class, 'show']);
