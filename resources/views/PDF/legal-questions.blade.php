...
<h3 class="text-center title text-white pt-2 pb-2">Registration Steps - Legal Question Explanation</h3>
...
@if($question->name == 'convicted_checkbox_1c')
    <div class="section-border">
        <p>
            <strong>1C. &nbsp;</strong>
            Have you ever been convicted of, or pled guilty or no contest to, a violation of federal or state securities
            or
...
@if($question->name == 'convicted_checkbox_1e')
    <div class="section-border">
        <p>
            <strong>1E. &nbsp;</strong>
            Has any foreign government, court, regulatory agency, or exchange ever entered an order against you related
            to
...
@if($question->name == 'lawsuit_checkbox_2')
    <div class="section-border">
        <p>
            <strong>2. &nbsp;</strong>
            Have you ever been, or are you currently being investigated, have any pending indictments, lawsuits, or have
            you
...
@if($question->name == 'lawsuit_checkbox_2d')
    <div class="section-border">
        <p>
            <strong>2D. &nbsp;</strong>
            Have you ever been named as a defendant or co-defendant in a lawsuit, or have you ever sued or been sued by
            an
            insurance company?
        </p>
...
@if($question->name == 'cancel_insu_cause_checkbox_6')
    <div class="section-border">
        <p>
            <strong>6. &nbsp;</strong>
            Have you ever had an appointment with any insurance company denied or terminated for cause? (If you have
            been
...
@if($question->name == 'insurer_checkbox_7')
    <div class="section-border">
        <p>
            <strong>7. &nbsp;</strong>
            Does any insurer, insured, or other person claim any commission chargeback or other indebtedness from you as
            a
...
@if($question->name == 'bankruptcy_checkbox_15')
    <div class="section-border">
        <p>
            <strong>15. &nbsp;</strong>
            Have you personally, or any insurance or securities brokerage firm with whom you have been associated, filed
            a
...
@if($question->name == 'bankruptcy_checkbox_15b')
    <div class="section-border">
        <p>
            ...
            petition,
            or been declared bankrupt, either during your association with them or within 5 years after termination of
            such
            an association?
        </p>
