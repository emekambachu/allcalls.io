...
<body class="empower" style="" cz-shortcut-listen="true">
    ...
    <main>
        <div class="main-container">
            <div class="txt-block">
                <h1 class="pop-up loading-pop-up d7 animat-popup">Empower Your <br class="br-mobile"> <span class="grand-gradient-phrase"><span class="gradient-phrase">Life Insurance </span><span class="gradient-phrase">Career</span></span> With AllCalls.io</h1>
    ...
    <section class="Partnerships">
        <p class="a-rated-carrier-p pop-up scroll-pop-up animat-popup">20+ A-rated Carrier Partnerships and dozen of products</p>
        <div class="box">
            ...
            <img class="mutual for-desktop partner-logo pop-up scroll-pop-up d2 animat-popup" src="/careers_files/mutual.png">
            <img class="mutual for-mobile partner-logo pop-up scroll-pop-up animat-popup" src="/careers_files/mutual-for-mobile.png">
            <img class="AIG partner-logo pop-up scroll-pop-up d3 animat-popup" src="/careers_files/AIG.png">
            <img class="americam-amicable partner-logo pop-up scroll-pop-up d4 animat-popup" src="/careers_files/americam-amicable.png">
            <img class="american-equity partner-logo pop-up scroll-pop-up d5 animat-popup" src="/careers_files/American.png">
            <img class="columbian-life-Insurance partner-logo pop-up scroll-pop-up d6 animat-popup" src="/careers_files/ColumbianLifeInsuranceCompany.png">
            <img class="athene partner-logo pop-up scroll-pop-up animat-popup" src="/careers_files/athene.png">
            <img class="colombus-life partner-logo pop-up scroll-pop-up d1 animat-popup" src="/careers_files/colombus-life.png">
            <img class="assurant partner-logo pop-up scroll-pop-up d2 animat-popup" src="/careers_files/assurant.png">
            <img class="north-american partner-logo pop-up scroll-pop-up d3 animat-popup" src="/careers_files/north-american.png">
            <img class="jh partner-logo pop-up scroll-pop-up d4 animat-popup" src="/careers_files/jh_white_logo_2x.png">
            <img class="foresters partner-logo pop-up scroll-pop-up d5 animat-popup" src="/careers_files/foresters-logo-en-white 1.png">
            <img class="transamerica partner-logo pop-up scroll-pop-up d6 animat-popup" src="/careers_files/transamerica.png">
            <img class="oxford partner-logo pop-up scroll-pop-up animat-popup" src="/careers_files/oxford.png">
            <img class="national-life partner-logo pop-up scroll-pop-up d1 animat-popup" src="/careers_files/national.png">
            <img class="occidental partner-logo pop-up scroll-pop-up d2 animat-popup" src="/careers_files/Occidental.png">
            <img class="CVS partner-logo pop-up scroll-pop-up d3 animat-popup" src="/careers_files/cvs.png">
            <img class="gerber-life-insurance partner-logo pop-up scroll-pop-up d4 animat-popup" src="/careers_files/Gerber-Life-Insurance-2.png">
    ...
    <section class="leads-marketing">
        ...
        <div class="boxes">
            ...
            <div class="box">
                ...
                <p class="pop-up scroll-pop-up d1 animat-popup">Agents are able to log into their web portal or mobile app and make themselves available to take calls
                    on demand.</p>
            </div>
            <div class="box">
        ...
        <img class="lead-marketing-gradients-middle-mobile for-mobile bright-gradient" src="/careers_files/lead-marketing-gradients-middle-mobile.svg">
        <img class="lead-marketing-gradients-bottom-mobile for-mobile bright-gradient" src="/careers_files/lead-marketing-gradients-bottom-mobile.svg">
    </section>
    ...
    <section class="training-onboarding">
        ...
        <div class="boxes">
            <div class="box img-glass-block pop-up scroll-pop-up animat-popup">
                ...
                <img class="training-onboarding-gradients-top-mobile bright-gradient bright-gradient-mobile" src="/careers_files/training-onboarding-gradients-top-mobile.svg">
            </div>
            <div class="box img-glass-block pop-up scroll-pop-up d1 animat-popup">
                ...
                <img class="training-onboarding-gradients-middle-mobile bright-gradient bright-gradient-mobile" src="/careers_files/training-onboarding-gradients-middle-mobile.svg">
            </div>
        ...
        <img class="training-onboarding-gradients-left bright-gradient bright-gradient-desktop" src="/careers_files/Training-Onboarding-gradients-left.svg">
        <img class="training-onboarding-gradients-middle bright-gradient bright-gradient-desktop" src="/careers_files/Training-Onboarding-gradients-middle.svg">
        <img class="training-onboarding-gradients-right bright-gradient bright-gradient-desktop" src="/careers_files/Training-Onboarding-gradients-right.svg">
    </section>
    ...
    <section class="ready-unlock">
        ...
        <div class="btns">
            ...
            <a href="https://www.financialservicecareers.com/unlicensedstart" class="get-licenced-btn btn-2 btn pop-up scroll-pop-up d1 animat-popup">
    ...
    <div class="join-us-modal modal">
        ...
        <form action="https://656a16294c31011321a8129b--stupendous-trifle-525211.netlify.app/">
