                ...
                <div class="flow-root">
                  <ul>
                    <li
                      ...
                      <img class="h-8 max-h-full mr-4 bg-gray-200 border border-gray-300 rounded shadow"
                        :src="`/img/${card.cardType}.svg`" :alt="card.cardType" />
                      <div class="w-full flex justify-between items-center">
                        <div>
                          <h3 class="text-xs text-gray-800 font-small tracking-wide">
                            {{
