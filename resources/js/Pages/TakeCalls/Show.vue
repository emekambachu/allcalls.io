          ...
          <ul>
            <li v-for="callType in callTypesWithToggles" :key="callType.callType.id" class="py-3 sm:py-4">
              <div class="flex justify-end items-center">
                <div class="text-xs text-gray-800">Turn calls on <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="w-4 h-4 relative my-1" style="left: 20px">
