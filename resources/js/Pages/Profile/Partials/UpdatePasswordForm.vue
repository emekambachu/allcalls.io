    ...
    <section>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                <AuthenticatedButton class="button-custom px-4 py-3 rounded-md " :disabled="form.processing" :class="{ 'opacity-25': form.processing }"><global-spinner :spinner="form.processing" />Save</AuthenticatedButton>
