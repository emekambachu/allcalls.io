                    ...
                    <div  class="thumbnail  cursor-pointer" @click="slideTo(index, basicTraining)">
                        ...
                        <div class="svg-container">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 528 528" xml:space="preserve"
                                fill="#239dfa" stroke="#239dfa">
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <polygon style="fill:#ffff;" points="192.496,154.928 192.496,363.8 388.12,259.368 " />
                                </g>
...
.carousel__slide--active {
    opacity: 1;
    transform: rotateY(0) scale(1.40);
}
