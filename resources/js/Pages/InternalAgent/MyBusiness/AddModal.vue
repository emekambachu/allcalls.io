...
const filteredAgents = computed(() => {
  return props.agents.filter((agent) => {
    return (
      ...
      (agent.first_name
        .toLowerCase()
        .includes(form.value.agent_full_name.toLowerCase()) ||
                    ...
                    >
                      ...
                      <div>
                        <label
                          ...
                          >Street Address 2<span class="text-red-400">*</span></label
                        >
                        <input
