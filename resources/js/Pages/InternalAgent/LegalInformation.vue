            ...
            <div style="width: 90%;">
                ...
                <div class="flex mt-4">
                    <div class="flex items-center mr-4">
                        <input :disabled="page.props.auth.role === 'admin'" :id="'default-radio-' + information.id + '-yes'"
                    ...
                    <div class="flex items-center">
                        <input :disabled="page.props.auth.role === 'admin'" :id="'default-radio-' + information.id + '-no'"
                    ...
                    <a :href="route('admin.agent.legal.question.pdf', [form[information.id], userData.id, information.question])"
                        ...
                        v-if="form[information.name] === 'YES' && page.props.auth.role === 'admin' && userData.internal_agent_contract.legal_question"
                ...
                <input :disabled="page.props.auth.role === 'admin'" type="text" v-show="form[information.name] === 'YES'"
                ...
                <div class="mt-3" v-show="form[information.name] === 'YES'">
                    <VueDatePicker :disabled="page.props.auth.role === 'admin'" v-model="form[information.name + '_date']"
