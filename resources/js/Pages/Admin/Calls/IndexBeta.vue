...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <div class="pt-14 px-16 flex items-center mb-2">
      <div class="rounded shadow mr-2 px-3 py-1 bg-gray-100 text-gray-800 text-lg"><span class="font-bold">id</span> is <span class="font-bold">19</span></div>
      <button class="rounded shadow mr-2 px-3 py-1 bg-gray-100 text-gray-800 text-lg">+</button>
    </div>
