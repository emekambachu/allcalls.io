            ...
            <table class="w-full text-sm text-left text-gray-500" style="min-height: 50px;">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                    <svg @click.prevent="openDetailedLogs(call.id)" title="Open Detailed Logs" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3 cursor-pointer text-gray-800 hover:text-gray-900">
