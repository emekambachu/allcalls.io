              ...
              <tr v-for="onlineUser in onlineUsers" :key="onlineUser.id" class="border-b border-gray-500">
                ...
                <td class="text-gray-600 px-4 py-3 ">
                  ...
                  <div class="flex items-center justify-center">
                    ...
                    <svg v-if="deviceName === 'Desktop'" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <svg v-if="deviceName === 'Android'" class="w-8 h-8 " viewBox="-22.5 0 301 301" version="1.1"
                ...
                <td class="text-gray-600 px-4 py-3">
                  <button @click.prevent="removeAgent(onlineUser.user.id)"
