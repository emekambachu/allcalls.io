...
watch(() => [form.first_name, form.last_name, form.email, form.password, form.password_confirmation, form.phone], async ([firstName, lastName, email, password, passwordConfirmation, phone]) => {
    if (
        firstName === "" ||
        lastName === "" ||
        email === "" ||
...
<template>
    <Transition name="modal" enter-active-class="transition ease-out duration-300 transform"
        ...
        <div id="defaultModal" v-if="agentModal" tabindex="-1"
                    ...
                    <div v-if="step == 0"  class="p-6">
                        <div>
                            <div>
                                ...
                                <GuestTextInput id="first_name" type="text" class="mt-1 block w-full"
                                    v-model="form.first_name" minlength="2" required pattern="[A-Za-z]{1,32}"
                            ...
                            <div class="mt-4">
                                ...
                                <GuestTextInput id="last_name" type="text" class="mt-1 block w-full"
                                    v-model="form.last_name" required pattern="[A-Za-z]{1,32}"
                                    onkeyup="this.value=this.value.replace(/[0-9]/g,'');" />
                            ...
                            <div class="mt-4">
                                ...
                                <GuestTextInput id="email" type="email" class="mt-1 block w-full" v-model="form.email"
                                    required pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" />
                                <div v-if="uiEmailValidation.isValid" class="text-red-500">Please enter valid email address.
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <GuestTextInput id="password" type="password" class="mt-1 block w-full"
                                    v-model="form.password" autocomplete="new-password" />

                                <!-- <InputError class="mt-2" :message="form.errors.password" /> -->
                                <div v-if="firstStepErrors.password" class="text-red-500"
                            ...
                            <div class="flex justify-end mt-6">
                                <PrimaryButton type="button" @click="NextTab(1)"
