...
let fetchTransactionsBypage = async (page) => {
  ...
  try {
    const response = await axios.get(
      `/admin/agent/transactions/${props.user.id}${url.search}`
    );
    const data = response.data; // Assuming your API response provides relevant data
    transactions.value = data.transactions;
    slidingLoader.value = false;
          ...
          <table class="w-full text-sm text-left text-gray-400">
            ...
            <tbody>
              ...
              >
                ...
                <td class="text-gray-600 px-4 py-3 font-bold">
              ...
              <ul class="inline-flex items-stretch -space-x-px cursor-pointer">
                <li>
                  <a
                    ...
                    @click="fetchTransactionsBypage(transactions.prev_page_url)"
                ...
                <li>
                  <a
                    ...
                    @click="fetchTransactionsBypage(transactions.next_page_url)"
