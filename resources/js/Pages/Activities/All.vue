    ...
    <AuthenticatedLayout>
        ...
        <section class="p-3 ">
            <div class="mx-auto max-w-screen-xl sm:px-12">
                <div class="bg-custom-blue relative shadow-md sm:rounded-lg overflow-hidden">
                    <div
                                ...
                                <tr v-for="activity in activities" :key="activity.id" class="border-b border-gray-500">
                                    <th scope="row"
                                        class="px-4 py-3 font-medium text-custom-white whitespace-nowrap">{{
                                            activity.user.first_name }} {{ activity.last_name }}</th>
                                    <td class="px-4 py-3">{{ activity.email }}</td>
                                    <td class="px-4 py-3">{{ formatDate(activity.last_activity_at) }}</td>
                                    <td class="px-4 py-3">{{ formatDate(activity.created_at) }}</td>
                                    <td class="px-4 py-3">{{ formatDate(activity.logout_time) }}</td>
