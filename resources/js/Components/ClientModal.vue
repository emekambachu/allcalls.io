      ...
      <div class="p-6">
        <div v-if="ClientDetail">
              ...
              <div class="ml-3">
                ...
                >
                  <div class="flex">
                    ...
                    <span
                      class="ml-2"
                      v-text="ClientDetail.unlocked ? 'Unlocked' : 'Locked'"
                    ></span>
                  </div>
                </div>
              </div>
          ...
          <h4
            ...
            class="text-2xl font-small text-custom-sky mb-2"
          >
            User Information
          </h4>
          <div
          ...
          >
            ...
            <div>
              ...
              {{
                ...
                ":" +
                String(ClientDetail.call?.call_duration_in_seconds % 60).padStart(2, "0")
              }}
            </div>
            <div>
  ...
  <div v-else class="relative w-full max-w-4xl max-h-full mx-auto">
    <div class="relative bg-white border border-gray-300 rounded-lg shadow-lg">
      ...
      <form v-if="form" class="p-6">
        ...
        <div
          v-if="$page.props.auth.role == 'admin'"
          class="grid sm:grid-cols-1 md:grid-cols-2 gap-2 text-gray-700 mb-6"
        >
          <div class="flex mt-1">
        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 gap-2 text-gray-700 mb-10">
          <div>
            ...
            >
              ...
              <option value="Customer had CHF, Cancer or Oxygen Use">Customer had CHF, Cancer or Oxygen Use</option>
            </select>
          </div>
        </div>
