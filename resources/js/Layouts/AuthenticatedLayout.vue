...
<!--            </div>-->
            ...
            >
              <button
                  ...
                  type="button"
                  class="flex items-center w-full p-2 text-base text-gray-100 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 hover:text-custom-green"
