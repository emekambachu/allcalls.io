...
// let disabledNavLink = ref(false);
// let disabledNavLinkTraining = ref(false);
...
//   disabledNavLinkTraining.value = true;
// }
...
<template>
  <div>
      ...
      <div v-if="$page.props.auth.role == 'admin'">
        <nav class="bg-custom-indigo border-b border-gray-800">
          ...
          <div :class="{
            ...
            <div class="pt-2 pb-3 space-y-1">
              <ResponsiveNavLink :href="route('admin.clients')" :active="route().current('admin.clients')">
                Clients
              </ResponsiveNavLink>
            </div>
            <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-3 space-y-1">
              <ResponsiveNavLink :href="route('admin.email-blacklist.index')"
        ...
        <div class="w-full mx-auto md:grid md:grid-cols-5 md:gap-28 md:max-w-screen-2xl xl:gap-0">
          <div class="py-12 hidden sm:-my-px sm:ml-10 col-span-1 md:flex md:flex-col">
            ...
            <NavLink class="mb-10 gap-2" :href="route('admin.clients')" :active="route().current('admin.clients')">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-8 h-8 mr-2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <NavLink class="mb-10 gap-2" :href="route('admin.email-blacklist.index')"
              :active="route().current('admin.email-blacklist.index')">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-8 h-8 mr-2">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    'mb-5':
      ...
      route().current('billing.autopay.index'),
            ...
            <NavLink :class="{ 'opacity-50': disabledNavLink === true }" :disabledNavLink="disabledNavLink"
  ...
  'text-custom-green': route().current('activities.index'),
    ...
    <Modal :show="showUpdateDispositionForLastClient && dispositionClient" :closeable="false">
      <DispositionModal :client="dispositionClient" @close="showUpdateDispositionForLastClient = false" />
    </Modal>

    <!-- <Modal :show="showLowBalanceModal" :closeable="true" @close="showLowBalanceModal = false">
      <div class="bg-white py-6 flex items-center justify-center ">
