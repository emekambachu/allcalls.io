      ...
      <div v-else>
        <nav class="bg-custom-indigo border-b border-gray-800">
          ...
          <div :class="{
            ...
            <div class="pt-2 pb-3 space-y-1">
              ...
              <!-- <ResponsiveNavLink :href="route('internal-agent.agent-agency.index')" :active="route().current('internal-agent.agent-agency.index')">
                My Agency
              </ResponsiveNavLink> -->
              <!-- <ResponsiveNavLink :href="route('internal-agent.my-agent.index')" :active="route().current('internal-agent.my-agent.index')">
                My Agent
              </ResponsiveNavLink> -->
        ...
        <div class="w-full mx-auto md:grid md:grid-cols-5 md:gap-28 md:max-w-screen-2xl xl:gap-0">
          <div class="py-12 hidden sm:-my-px sm:ml-10 col-span-1 md:flex md:flex-col">
            ...
            <!-- <NavLink class="mb-10 gap-2" :href="route('internal-agent.agent-agency.index')"
            ...
            <!-- <NavLink class="mb-10 gap-2" :href="route('internal-agent.my-agent.index')"
