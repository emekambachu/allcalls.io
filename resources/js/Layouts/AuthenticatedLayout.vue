  ...
  axios
    ...
    .then((response) => {
      ...
      axios
        ...
        .then((response) => {})
        .catch((error) => {
          console.error("Error logging the device action:", error);
        });
    })
    .catch((error) => {
      console.error("Error getting the device id:", error);
    });
};
...
let showUpdateDispositionModal = (updateForOldClient) => {
  ...
  if (
    updateForOldClient &&
    page.props.auth.show_disposition_update_option &&
    page.props.auth.disposition_client
  ) {
...
onMounted(() => {
  ...
  Echo.private(`${page.props.auth.user.id}.notifications`).listen(
    ...
    (e) => {
      ...
      console.log(
        "It was accepted or rejected on some other device OR it was a missed call."
      );
        ...
        <nav class="bg-custom-indigo border-b border-gray-800">
          ...
          >
            <div class="pt-2 pb-3 space-y-1">
              ...
              >
                <div class="text-lg font-bold px-3 py-2 text-white">Notifications</div>
...
>>>>>>> 8c8b4c6cbebfeef31fee04d5f054a175696d23bf
          <button
