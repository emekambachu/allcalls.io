      ...
      <div v-if="$page.props.auth.role == 'admin'">
        <nav class="bg-custom-indigo border-b border-gray-800">
          ...
          <div :class="{
            ...
            <div class="pt-2 pb-3 space-y-1">
              <ResponsiveNavLink :href="route('admin.transactions')" :active="route().current('admin.transactions')">
                Transactions
              </ResponsiveNavLink>
            </div>
            <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-3 space-y-1">
              <ResponsiveNavLink :href="route('admin.internal.agent.level.index')"
            ...
            <div class="pt-2 pb-3 space-y-1">
              <ResponsiveNavLink :href="route('admin.my-business.index')"
        ...
        <div class="w-full mx-auto md:grid md:grid-cols-5 md:gap-28 md:max-w-screen-2xl xl:gap-0">
          <div class="py-12 hidden sm:-my-px sm:ml-10 col-span-1 md:flex md:flex-col">
            ...
            <NavLink class="mb-10 gap-2" :href="route('admin.transactions')"
            ...
            <NavLink class="mb-10 gap-2" :href="route('admin.my-business.index')"
              :active="route().current('admin.my-business.index')">
            ...
            <NavLink class="mb-10 gap-2" :href="route('admin.available-number.index')"
              :active="route().current('admin.available-number.index')">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-8 h-8 mr-2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <NavLink class="mb-10 gap-2" id="billing-nav-link" :href="route('profile.view')"
              :active="route().current('profile.view') || route().current('profile.edit')" :class="{
                'mb-5':
              ...
              <svg v-if="route().current('profile.view') || route().current('profile.edit')"
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
              </svg>
            </NavLink>
            <div v-if="route().current('profile.view') || route().current('profile.edit')"
      ...
      <div v-else>
        <nav class="bg-custom-indigo border-b border-gray-800">
                      ...
                      <transition enter-active-class="transition duration-100 ease-out"
                        ...
                        <MenuItems
                          ...
                          <div class="px-3 py-2 text-sm text-gray-600 font-bold flex items-center justify-between"
                            ...
                            <div class="cursor-pointer text-xs py-2 text-gray-800 hover:text-gray-500"
                          ...
                          <div style="max-height: 400px; overflow-y: scroll">
                            <div v-for="(notification, index) in userNotifications" :key="notification.id"
                              class="p-1 cursor-pointer">
                              <MenuItem>
                              <div class="flex flex-col gap-1 p-2 rounded-md hover:bg-custom-blue hover:text-white">
                                <!-- Notification Title -->
                                <p class="text-sm font-semibold">
                                  {{ notification.data.title }}
                                </p>
                          ...
                          <div v-if="!userNotifications.length" class="text-center py-3 text-md">
          ...
          <div :class="{
            ...
            <div class="pt-2 pb-3 space-y-1">
              <ResponsiveNavLink :href="route('take-calls.show')" :class="{ 'opacity-50': disabledNavLink === true }"
                :disabledNavLink="disabledNavLink" :active="route().current('take-calls.show')">
                Take Calls
              </ResponsiveNavLink>

              <ResponsiveNavLink :href="route('clients.index')" :class="{ 'opacity-50': disabledNavLink === true }"
                :disabledNavLink="disabledNavLink" :active="route().current('clients.index')">
                Clients
              </ResponsiveNavLink>
              ...
              <ResponsiveNavLink :class="{ 'opacity-50': disabledNavLink === true }" :disabledNavLink="disabledNavLink" :href="route('billing.funds.index')" :active="route().current('billing.funds.index') ||
                ...
                <div v-if="route().current('billing.funds.index') ||
                  ...
                  <ul>
                    ...
                    <li class="mb-3">
                      <Link href="/billing/cards" class="inline-flex items-center rounded-t-lg hover:text-custom-green"
                        :class="{
              ...
              <ResponsiveNavLink :class="{ 'opacity-50': disabledNavLink === true }" :disabledNavLink="disabledNavLink" :href="route('calls.index')" :active="route().current('calls.index')">
                Call Reporting
              </ResponsiveNavLink>

              <ResponsiveNavLink :class="{ 'opacity-50': disabledNavLink === true }" :disabledNavLink="disabledNavLink" :href="route('additional-files.index')" :active="route().current('additional-files.index')">
                Additional Files
              </ResponsiveNavLink>
              ...
              <ResponsiveNavLink :href="route('activities.index')" :active="route().current('activities.index') ||
                ...
                <div v-if="route().current('activities.index') ||
                  ...
                  <ul>
                    ...
                    <li class="mb-3">
                      <Link :style="{ 'pointer-events': disabledNavLink ? 'none' : 'pointer' }" href="/transactions" class="inline-flex items-center rounded-t-lg hover:text-custom-green"
                        :class="{
        ...
        <div class="w-full mx-auto md:grid md:grid-cols-5 md:gap-28 md:max-w-screen-2xl xl:gap-0">
          <div class="py-12 hidden sm:-my-px sm:ml-10 col-span-1 md:flex md:flex-col">
            ...
            <NavLink class="mb-10 gap-2 " :class="{ 'opacity-50': disabledNavLink === true }"
              :disabledNavLink="disabledNavLink" :href="route('take-calls.show')"
            ...
            <NavLink class="mb-10 gap-2" :class="{ 'opacity-50': disabledNavLink === true }"
              :disabledNavLink="disabledNavLink" :href="route('clients.index')"
              :active="route().current('clients.index')">
              <img src="/img/clients.png" alt="" />
              Clients
            </NavLink>

            <NavLink v-if="$page.props.auth.role === 'internal-agent'"
              :class="{ 'opacity-50': disabledNavLink === true }" :disabledNavLink="disabledNavLink" class="mb-10 gap-2"
              :href="route('internal-agent.agent-agency.index')"
              :active="route().current('internal-agent.agent-agency.index')">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-8 h-8 mr-2">
            ...
            <NavLink class="mb-10 gap-2" :class="{ 'opacity-50': disabledNavLink === true }"
              :disabledNavLink="disabledNavLink" :href="route('calls.index')" :active="route().current('calls.index')">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-8 h-8 mr-2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            :class="{ 'opacity-50': disabledNavLink === true }"
              ...
              class="mb-10 gap-2" :href="route('additional-files.index')"
            ...
            <div v-if="route().current('activities.index') ||
              ...
              <ul>
                ...
                <li v-if="$page.props.auth.role === 'internal-agent'"
                  class="mb-3">
                  <Link  :style="{ 'pointer-events': disabledNavLink ? 'none' : 'pointer' }" aria-current="page" class="inline-flex items-center rounded-t-lg hover:text-custom-green group"
                    :class="{
                      'opacity-25': disabledNavLink === true,
                      'text-custom-green': route().current('transactions.index'),
