      ...
      <div v-if="$page.props.auth.role == 'admin'">
        <nav class="bg-custom-indigo border-b border-gray-800">
          ...
          <div :class="{
            ...
            <div class="pt-2 pb-3 space-y-1">
              <ResponsiveNavLink :href="route('admin.agent.internal.agent')"
                :active="route().current('admin.agent.internal.agent')">
                Leagal Questions
              </ResponsiveNavLink>
            </div>
            <div class="pt-2 pb-3 space-y-1">
        ...
        <div class="w-full mx-auto md:grid md:grid-cols-5 md:gap-28 md:max-w-screen-2xl xl:gap-0">
          <div class="py-12 hidden sm:-my-px sm:ml-10 col-span-1 md:flex md:flex-col">
            ...
            <NavLink class="mb-10 gap-2" :href="route('admin.agent.internal.agent')" :active="route().current('admin.agent.internal.agent')
              ">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
